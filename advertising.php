<?php require_once( 'edit/cms.php' ); ?>
    <cms:template title='Advertising' order='9'>
        <cms:editable type='textarea' name='advertising_info' label='Advertising Information' height='100' />
</cms:template>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body>
        ...
        <div class="body">
            ...
            <br>
            <p class="lead"><cms:show advertising_info /> For more information you can contact our head of advertising directly <a href="mailto:advertising@smasingers.org?subject=Advertising%Question">by clicking here.</a></p>
