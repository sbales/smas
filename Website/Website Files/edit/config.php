<?php
    ...
    //define( 'K_SITE_URL', 'http://www.smasingers.org' );
    ...
    define( 'K_DB_NAME', 'smasinge_smas' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'smasinge_smas' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'smas2016!' );
    // 7.
    ...
    define( 'K_EMAIL_TO', 'advertising@smasingers.org' );

    // 14.
    // Will be used as the sender of messages delivered by contact forms to the address above.
    define( 'K_EMAIL_FROM', 'contact@smasingers.org' );
