            ...
            <div class="row season-details">
                <div class="column medium-6 large-3">
                    <p class="date">
                        ...
                        <cms:show concert_time1 />
                    </p>
                    <p class="concert-name">
                        <cms:show concert_name1 />
                    </p>
                    <p class="info">
                        <cms:show concert_info1 />
                    </p>
                    <p class="location">
                        <cms:show concert_location1 />
                    </p>
                    <p class="cost">
                        <cms:show concert_cost1 />
                    </p>
                </div>
                <div class="column medium-6 large-3">
                    <p class="date">
                        ...
                        <cms:show concert_time2 />
                    </p>
                    <p class="concert-name">
                        <cms:show concert_name2 />
                    </p>
                    <p class="info">
                        <cms:show concert_info2 />
                    </p>
                    <p class="location">
                        <cms:show concert_location2 />
                    </p>
                    <p class="cost">
                        <cms:show concert_cost2 />
                    </p>
                </div>
                <div class="column medium-6 large-3">
                    <p class="date">
                        ...
                        <cms:show concert_time3 />
                    </p>
                    <p class="concert-name">
                        <cms:show concert_name3 />
                    </p>
                    <p class="info">
                        <cms:show concert_info3 />
                    </p>
                    <p class="location">
                        <cms:show concert_location3 />
                    </p>
                    <p class="cost">
                        <cms:show concert_cost3 />
                    </p>
                </div>
                <div class="column medium-6 large-3">
                    <p class="date">
                        ...
                        <cms:show concert_time4 />
                    </p>
                    <p class="concert-name">
                        <cms:show concert_name4 />
                    </p>
                    <p class="info">
                        <cms:show concert_info4 />
                    </p>
                    <p class="location">
                        <cms:show concert_location4 />
                    </p>
                    <p class="cost">
                        <cms:show concert_cost4 />
                    </p>
                </div>
            </div>
            <h2><a href="auditions">Auditions</a></h2>
            <cms:pages masterpage='index.php'>
                <cms:if audition_btn=='yes'>
                    <p class="lead">Auditions season is currently open. <a href="<cms:show audition_link />">Click Here to apply for an audition time slot.</a> </p>
